...
public class ProductService implements IProductDAO {
	...
	public List<Product> getAllProduct() {
		...
		try {
			...
			System.out.println(this.getClass().getPackage() + " " + this.getClass().getName() + " " + exception);
	...
	/**
	 * This method will insert a new product into database (Product and productprice table)
	 */
	@Override
